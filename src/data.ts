...
export const mockMedicalOrders: MedicalOrder[] = [
  ...
  },
  {
    id: 'ML-2026-0002',
    clientId: 'c2',
    clientName: 'مركز تجميل ديرما',
    clientPhone: '+971 55 987 6543',
    clientEmail: 'contact@derma-dxb.ae',
    clientCountry: 'الإمارات العربية المتحدة',
    clientCity: 'دبي',
    clientAddress: 'جميرا - شارع الوصل',
    clientType: 'Clinic',
    items: [
      { 
        productId: 'p2', 
    ...
    executionLocation: 'Turkey',
    notes: {
      internal: 'تم دفع 90% مقدم',
      external: 'شحن مبرد',
      paymentTerms: 'مقدم كامل',
      deliveryTerms: 'شحن جوي',
      returnPolicy: 'خاضع لسياسة المستلزمات'
    },
    attachments: []
  },
  {
    ...
    clientPhone: '+966 50 123 4567',
    clientEmail: 'info@shifa-hosp.sa',
    clientCountry: 'السعودية',
    clientCity: 'الرياض',
    clientAddress: 'حي الملز',
    clientType: 'Hospital',
    items: [],
    financials: {
      subtotal: 5000,
    ...
    shipping: { method: 'Office Pickup', shippingCost: 0, paidBy: 'Client' },
    payment: { method: 'Cash' },
    status: 'Admin Review',
    category: 'Hospital Request',
    date: new Date().toISOString(),
    executionLocation: 'Turkey',
    notes: {
      internal: '',
