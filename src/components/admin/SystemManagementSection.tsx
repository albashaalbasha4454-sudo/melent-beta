...
export const SystemManagementSection: React.FC = () => {
  ...
  const permanentlyDelete = (binId: string) => {
    if (confirm('سيتم حذف هذا العنصر نهائياً من سلة المهملات. هل أنت متأكد؟')) {
       if (LocalDB.permanentlyDeleteFromRecycleBin(binId)) {
          refreshData();
       }
    }
  };
                             ...
                             <div className="flex items-center gap-2">
                                ...
                                >
                                 ...
                                 <button 
                                   ...
                                   className="p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-600 hover:text-white transition-all scale-95" 
                                   title="حذف نهائي"
                                 >
                                   <Trash2 size={14} />
                                </button>
